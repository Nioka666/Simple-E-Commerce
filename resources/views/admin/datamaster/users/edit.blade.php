                    ...
                    <div class="card card-primary">
                        ...
                        <form action="{{ route('usersUpdate', $users->id) }}" method="POST">
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    <label for="password">Password <span class="text-danger">* isi password jika ingin
                                            mengganti yg
                                            lama</span></label>
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="provinsi" id="provinsi" class="form-control"
                                        ...
                                        <option value="{{ $prov->id_provinsi }} " {{ $prov->id_provinsi ==
                                            $users->provinsi_id ? 'selected' : '' }}>
                                            {{ $prov->nama_provinsi }}
                                        </option>
                                        @endforeach
                                    </select>
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea name="alamat_lengkap" class="form-control" id="alamat_lengkap"
                                        placeholder="Masukkan Alamat Lengkap" cols="30"
                                        rows="5">{{ old('alamat_lengkap') ? old('alamat_lengkap') : $users->alamat_lengkap }}</textarea>
                                </div>
